...
static const char *FAN_MODE_1 = "1";
static const char *FAN_MODE_2 = "2";
static const char *FAN_MODE_3 = "3";
static const char *FAN_MODE_4 = "4";
...
void Genvexv2Climate::control(const climate::ClimateCall& call) {
  ...
  if (call.get_mode().has_value()) {
    ...
    switch (mode) {
      ...
      case climate::CLIMATE_MODE_AUTO: {
        ...
        this->custom_fan_mode_ = FAN_MODE_2;
        ...
        if (optional_genvexv2_fan_mode.has_value()) {
          ...
          fan_speed_number_->make_call().set_value(genvexv2_fan_mode).perform();
        }
        break;
      }
      default:
  ...
  if (call.get_custom_fan_mode() != nullptr) {
    ...
    this->custom_fan_mode_ = new_custom_fan_mode;
    this->fan_mode_.reset();
...
climate::ClimateTraits Genvexv2Climate::traits() {
  ...
  traits.set_supported_custom_fan_modes({FAN_MODE_1, FAN_MODE_2, FAN_MODE_3, FAN_MODE_4});
  traits.set_supported_fan_modes({climate::ClimateFanMode::CLIMATE_FAN_OFF});
  traits.set_supported_modes({
    climate::ClimateMode::CLIMATE_MODE_OFF,
    climate::ClimateMode::CLIMATE_MODE_AUTO,
  });

  traits.add_supported_feature(climate::ClimateFeature::FEATURE_CURRENT_TEMPERATURE);
...
void Genvexv2Climate::genvexv2fanspeed_to_fanmode(const int state) {
  ...
  switch (state) {
    case 1:
      ...
      this->custom_fan_mode_ = FAN_MODE_1;
      break;
    case 2:
      ESP_LOGD(TAG, "Case 2");
      this->mode = climate::CLIMATE_MODE_AUTO;
    ...
    case 3:
      ESP_LOGD(TAG, "Case 3");
      this->mode = climate::CLIMATE_MODE_AUTO;
      this->custom_fan_mode_ = FAN_MODE_3;
      break;
    case 4:
      ESP_LOGD(TAG, "Case 4");
      this->mode = climate::CLIMATE_MODE_AUTO;
      this->custom_fan_mode_ = FAN_MODE_4;
      break;
    case 0:
      ESP_LOGD(TAG, "Case 0");
      this->fan_mode = climate::CLIMATE_FAN_OFF;
